...
namespace Watchdog.Infrastructure.Migrations
{
    ...
    [Migration("20260505112958_AddEngineConfigToSystemConfig")]
    partial class AddEngineConfigToSystemConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Watchdog.Domain.Entities.HealthSnapshot", b =>
                {
                    ...
                    b.Property<double>("AppCpuUsage")
                        .HasColumnType("float");

                    b.Property<Guid>("AppId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("AppRamUsage")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("SystemCpuUsage")
                        .HasColumnType("float");

                    b.Property<double>("SystemRamUsage")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Watchdog.Domain.Entities.Incident", b =>
                {
                    ...
                    b.Property<string>("FailedComponent")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
