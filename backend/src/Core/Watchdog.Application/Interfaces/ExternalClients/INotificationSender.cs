...
namespace Watchdog.Application.Interfaces.ExternalClients
{
    public interface INotificationSender
    {
        ...
        Task SendDowntimeAlertAsync(string toEmail, Incident incident, MonitoredApp app);

        // Sistem tekrar ayağa kalktığında gönderilecek "Her şey yolunda" e-postası
        Task SendRecoveryAlertAsync(string toEmail, Incident incident, MonitoredApp app);
